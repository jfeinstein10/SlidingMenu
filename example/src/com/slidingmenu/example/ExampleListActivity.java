...
import com.slidingmenu.example.bugs.HorizontalScrollActivity;
...
public class ExampleListActivity extends SherlockPreferenceActivity {
	...
	public boolean onPreferenceTreeClick(PreferenceScreen screen, Preference pref) {
		...
		} else if (title.equals(getString(R.string.horizontal_scroll_title))) {
            cls = HorizontalScrollActivity.class;
        }
