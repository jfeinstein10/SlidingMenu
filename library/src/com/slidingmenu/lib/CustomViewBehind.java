...
public class CustomViewBehind extends ViewGroup {
	...
	private int mFadeMode = SlidingMenu.FADEMODE_MENU;
	...
	public void drawFadeMenu(View content, Canvas canvas, float openPercent) {

		if (!mFadeEnabled || mFadeMode == SlidingMenu.FADEMODE_CONTENT)
			return;
	...
	public void drawFadeAboveContent(View content, Canvas canvas,
			float openPercent) {
		if (!mFadeEnabled || mFadeMode == SlidingMenu.FADEMODE_MENU)
			return;
